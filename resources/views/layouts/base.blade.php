...
<body>
    ...
    <!-- Ajout de la librairie Bootstrap -->
    ...
    <script>
        ...
        /*
          document.addEventListener("DOMContentLoaded", function() {
            const images = document.querySelectorAll('.fancybox-image');
            images.forEach(function(image) {
              image.addEventListener('click', function() {
                ...
                const instance = new fancybox(options);
                instance.show();
              });
            });
          });
        ...
        //morrison
        document.addEventListener("DOMContentLoaded", function() {
            var lienAffichage = document.getElementById("affichage-lien_morrison");

                                                ...
                                                <table border="0" align="right" cellpadding="0" cellspacing="0" role="presentation" class="row" width="280" style="width:280px;max-width:280px;">
                                                    <tr  >
                                                        <td align="left" class="center-text">
                                                            <a href="{{ url('/') }}"><img style="width:72px;border:0px;display: inline!important;" src="{{ asset('assets/img/logos/logo_header.png') }}" width="72" border="0"       alt="logo"></a>
                                                        </td>
                                                    </tr>
                                                </table>
                                                <!-- column -->
                ...
                <tr>
                    <td align="center"  bgcolor="#FFFFFF" class="container-padding">
                        ...
                        <table border="0" align="center" cellpadding="0" cellspacing="0" role="presentation" class="row" width="580" style="width:580px;max-width:580px;">
                            ...
                            <tr  >
                                <td class="center-text"  align="center" style="font-family:'Roboto Slab',Arial,Helvetica,sans-serif;font-size:30px;line-height:42px;font-weight:200;font-style:normal;color:#282828;text-decoration:none;letter-spacing:0px;">

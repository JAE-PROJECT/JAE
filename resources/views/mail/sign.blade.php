    ...
    <tr><!-- Outer Table -->
        <td align="center"  bgcolor="#f0f0f0" data-composer>
            ...
            <table border="0" align="center" cellpadding="0" cellspacing="0" role="presentation" width="100%" style="width:100%;max-width:100%;" >
                <!-- lotus-header-1 -->
                <tr>
                    <td align="center"  bgcolor="#7F3D00" class="container-padding">
                        ...
                        <table border="0" align="center" cellpadding="0" cellspacing="0" role="presentation" class="row" width="580" style="width:580px;max-width:580px;">
                                                ...
                                                <table border="0" align="right" cellpadding="0" cellspacing="0" role="presentation" class="row" width="280" style="width:280px;max-width:280px;">
                                                    <tr  >
                                                        <td align="left" class="center-text">
                                                            <a href="{{ url('/') }}"><img style="width:72px;border:0px;display: inline!important;" src="{{ asset('img/logo_header.png') }}" width="72" border="0"       alt="logo"></a>
                                                        </td>
                                                    </tr>
                                                </table>
                                                <!-- column -->
                            ...
                            <tr  >
                                <td align="center" class="center-text">
                                    <img style="width:190px;border:0px;display: inline!important;" src="{{ asset('img/emails/Email-1_Intro.png') }}" width="190" border="0"       alt="intro">
                                </td>
                            </tr>
                            <tr  >
                                <td height="40" style="font-size:40px;line-height:40px;" >&nbsp;</td>
            ...
            <table border="0" align="center" cellpadding="0" cellspacing="0" role="presentation" width="100%" style="width:100%;max-width:100%;" >
                ...
                <tr  >
                    <td align="center"  bgcolor="#FFFFFF">
                        <img style="width:50px;border:0px;display: inline!important;" src="{{ asset('img/emails/Arrow.png') }}" width="50" border="0"       alt="arrow">
                    </td>
                </tr>
            </table>
                ...
                <tr>
                    <td align="center"  bgcolor="#FFFFFF" class="container-padding">
                        ...
                        <table border="0" align="center" cellpadding="0" cellspacing="0" role="presentation" class="row" width="580" style="width:580px;max-width:580px;">
                            ...
                            <tr  >
                                <td class="center-text"  align="center" style="font-family:'Roboto Slab',Arial,Helvetica,sans-serif;font-size:25px;line-height:42px;font-weight:200;font-style:normal;color:#282828;text-decoration:none;letter-spacing:0px;">

                                    <div  >
                                        <p style="margin: 0;
  text-indent: 2rem;
  text-align: justify;">
                                      Hello {{ $user->nom }} {{ $user->prenom }} ! <br> Nous espérons que vous vous portez pour le mieux ? <br>

Nous sommes honorés de vous compter parmi nous pour {{ $event->event_titre }} avec {{ $event->orateur  }} . <br>

Rendez-vous  le {{ Carbon\Carbon::parse($event->event_date)->format('d/m/Y') }}  prochain à {{ $event->event_heure }} GMT. <br>

<ul>
Notes :
<li>Téléchargez l’application ZOOM et invitez au maximum! </li>
<li>Suivez toute notre actualité sur nos différentes pages; toutes les informations importantes s'y trouvent.</li>
</ul>
<br>

*Une invitation spéciale pour notre invité (e) spécial (e)* <br>

Vive la Jeune Afrique Entreprenante!
                                        </p>
                                    </div>
                                                ...
                                                <table border="0" align="left" cellpadding="0" cellspacing="0" role="presentation" class="row" width="480" style="width:480px;max-width:480px;">
                                                    <tr  >
                                                        <td class="center-text"  align="left" style="font-family:'Roboto Slab',Arial,Helvetica,sans-serif;font-size:20px;line-height:28px;font-weight:400;font-style:normal;color:#343e9e;text-decoration:none;letter-spacing:0px;">
                                                            ...
                                                            <div  >
                                                                 — Ensemble nous irons loin avec une jeunesse mobilisée et entreprenante —
                                                            </div>
